...
inherit eutils flag-o-matic multilib multiprocessing python-r1 toolchain-funcs versionator subversion

MY_P=${PN}_$(replace_all_version_separators _)
DESCRIPTION="Boost Libraries for C++"
HOMEPAGE="http://www.boost.org/ http://boost-log.sourceforge.net"
SRC_URI="mirror://sourceforge/boost/${MY_P}.tar.bz2"

BOOST_LOG_REV="799"
ESVN_REPO_URI="https://boost-log.svn.sourceforge.net/svnroot/boost-log/trunk/boost-log/@${BOOST_LOG_REV}"
