...
SLOT="0"
KEYWORDS="~amd64 ~x86"
IUSE="kerberos mms-agent sharedclient spidermonkey ssl static-libs std-cxx11"
...
pkg_setup() {
	...
	# TODO scons_opts+=" --use-system-boost"
...
src_compile() {
	# TODO if use std-cxx11; then
	#	CXXFLAGS+=" -std=c++11 -DBOOST_NO_SCOPED_ENUMS -DBOOST_NO_CXX11_SCOPED_ENUMS"
	#fi
